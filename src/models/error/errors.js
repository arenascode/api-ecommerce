...
export class UploadFileError extends Error {
  constructor(message, details) {
    super(message);
    this.name = "Uploading files Error";
    this.details = details;
    this.timestamp = Date().toString();
    this.trackrace = this.captureStackTrace();
  }
...
errors.outOfStock = new OutOfStockError('Product Out of Stock', 'Cart Service Post New Cart')
errors.uploadFileError = new UploadFileError('Error uploading file', )
